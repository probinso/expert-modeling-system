...
which are more concerned with text-content and writing style, which are usually
used for attribution and plagerism. However, in this case we are concerned with SMEs,
which are subjects (or authors) described as experts of matters (or topics).
...
not distinct. Ideally, this should also yield a useful bases for clustering document
